...
namespace WebAPICode.Helpers
{
    public class DBHelper
    {
        ...
        private static readonly string connectionString = "data source=garageserver.database.windows.net,1433;Initial Catalog=Garage_Live;Persist Security Info=True;User ID=garageadmin;Password=Tech@963;Encrypt=True;TrustServerCertificate=True;";
